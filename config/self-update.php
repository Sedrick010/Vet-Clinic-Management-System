...
return [
    ...
    */
    ...
    'version_installed' => env('SELF_UPDATER_VERSION_INSTALLED', '1.0.3'),
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type'                 => 'github',
            'repository_vendor'    => env('SELF_UPDATER_REPO_VENDOR', 'Sedrick010'),
            'repository_name'      => env('SELF_UPDATER_REPO_NAME', 'Vet-Clinic-Management-System'),
            'repository_url'       => '',
            'download_path'        => env('SELF_UPDATER_DOWNLOAD_PATH', storage_path('self-updater')),

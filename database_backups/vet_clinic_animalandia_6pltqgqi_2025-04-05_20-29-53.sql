...
--
-- Host: localhost    Database: vet_clinic_animalandia_6pltqgqi
-- ------------------------------------------------------
...
--
-- Current Database: `vet_clinic_animalandia_6pltqgqi`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `vet_clinic_animalandia_6pltqgqi` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `vet_clinic_animalandia_6pltqgqi`;
...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `appointments_staff_id_foreign` FOREIGN KEY (`staff_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `medical_records` (
  ...
  KEY `medical_records_staff_id_foreign` (`staff_id`),
  CONSTRAINT `medical_records_appointment_id_foreign` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`),
  CONSTRAINT `medical_records_pet_id_foreign` FOREIGN KEY (`pet_id`) REFERENCES `pets` (`id`),
  CONSTRAINT `medical_records_staff_id_foreign` FOREIGN KEY (`staff_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (1,'2024_03_31_000001_create_tenant_tables',1),(2,'2024_07_01_000001_create_tenant_users_table',1);
...
INSERT INTO `users` VALUES (1,'Albert Einstein','alberteinstein123@gmail.com',NULL,'$2y$12$ClU0w0rEl96868dWeh6QQOvbZ/zo5LS4ozDv/Cde49tpbiUuaQBTi','owner',NULL,'2025-04-05 09:21:30','2025-04-05 09:21:30');
...
-- Dump completed on 2025-04-06  2:29:53
